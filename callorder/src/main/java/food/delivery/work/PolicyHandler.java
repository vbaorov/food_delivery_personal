...
public class PolicyHandler {
    @Autowired
    CallOrderRepository orderRepository;
    /*
     * @StreamListener(KafkaProcessor.INPUT) public void
     * wheneverDeliveryStarted_UpdateOrderStatus(@Payload DeliveryStarted
     * deliveryStarted){
     * 
     ...
     * 
     * //deliveryStatus 보고 확인하여 변경해주 order.setOrderStatus("deliveryStarted");
     * orderRepository.save(order);
     * 
     * }
     * 
     * @StreamListener(KafkaProcessor.INPUT) public void
     * wheneverDeliveryCancled_UpdateOrderStatus(@Payload DeliveryCanceled
     * deliveryCanceled){
     * 
     ...
     * 
     * Optional<Order> orderResponse =
     * orderRepository.findById(deliveryCanceled.getOrderId());
     * 
     * Order order = orderResponse.get(); order.setOrderStatus("deliveryCanceled");
     * orderRepository.save(order);
     * 
     * }
     * 
     * @StreamListener(KafkaProcessor.INPUT) public void
     * wheneverCouponPublished_UpdateCouponStatus(@Payload CouponPublished
     * couponpublished){
     * 
     * if(!couponpublished.validate()) return;
     * 
     * System.out.println("\n\n##### listener UpdateOrderStatus : " +
     * couponpublished.toJson() + "\n\n");
     * 
     * Optional<Order> orderResponse =
     * orderRepository.findById(couponpublished.getOrderId());
     * 
     * Order order = orderResponse.get();
     ...
     * 
     * @StreamListener(KafkaProcessor.INPUT) public void
     * wheneverCouponCanceled_UpdateCouponStatus(@Payload CouponCanceled
     * couponcanceled){
     * 
     * if(!couponcanceled.validate()) return;
     * 
     * System.out.println("\n\n##### listener UpdateOrderStatus : " +
     * couponcanceled.toJson() + "\n\n");
     * 
     * Optional<Order> orderResponse =
     * orderRepository.findById(couponcanceled.getOrderId());
     * 
     * Order order = orderResponse.get();
